...
import "./modalPrivTerms.css";

function ModalPrivTerms({ active,onClose }: { active: boolean; onClose: Function; }) {
  ...
  return (
    <section className={active ? "modalPrivTerms active" : "modalPrivTerms"} onClick={(e) => e.stopPropagation} >
      <div className="modalContent" style={{ width: `${width * 0.8}px`, height: `${height * 0.8}px` }}>
        <button className="closeModal" onClick={handleClose}>
            <img src="/assets/icons/xmark-solid.svg" alt="close"/>
        </button>
        <h2 className="modalH">Privacy Policy</h2>
        <h2 className="modalH">Last updated: April 13, 2023</h2>
        <p>
        ...
        <h3 className="modalH">Interpretation and Definitions</h3>
        <h4 className="modalH">Interpretation</h4>
        <p>
        ...
        <h4 className="modalH">Definitions</h4>
        ...
        <p>
          ...
          this Agreement) refers to Help Ukrainian, 519 Riverfront Ave SE.
        </p>
        <p>
        ...
        <p> Country refers to: Alberta, Canada</p>
        <p>
        ...
        <p>
          Website refers to Help Ukrainian, accessible from
          https://www.helpukrainian.ca
        </p>
        <p>
        ...
        <h3 className="modalH">Collecting and Using Your Personal Data</h3>
        <h4 className="modalH">Types of Data Collected</h4>
        <h4 className="modalH">Personal Data</h4>
        <p>
        ...
        <h3 className="modalH">Usage Data</h3>
        ...
        <h4 className="modalH">Information from Third-Party Social Media Services</h4>
        <p>
        ...
        <h4 className="modalH">Tracking Technologies and Cookies</h4>
        <p>
        ...
        <h3 className="modalH">Use of Your Personal Data</h3>
        ...
        <h4 className="modalH">Retention of Your Personal Data</h4>
        <p>
        ...
        <h4 className="modalH">Transfer of Your Personal Data</h4>
        <p>
        ...
        <h4 className="modalH">Delete Your Personal Data</h4>
        <p>
        ...
        <h3 className="modalH">Disclosure of Your Personal Data</h3>
        <h4 className="modalH">Business Transactions</h4>
        <p>
        ...
        <h4 className="modalH">Law enforcement</h4>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h3 className="modalH">Other legal requirements</h3>
        <p>
        ...
        <h3 className="modalH">Security of Your Personal Data</h3>
        <p>
        ...
        <h2 className="modalH">Children's Privacy</h2>
        <hr></hr>
        <p>
        ...
        <h2 className="modalH">Links to Other Websites</h2>
        <hr></hr>
        <p>
        ...
        <h2 className="modalH">Changes to this Privacy Policy</h2>
        <hr></hr>
        <p>
        ...
        <h2 className="modalH">Contact Us</h2>
        <hr></hr>
        <p>
          If you have any questions about this Privacy Policy, You can contact
          us:
        </p>
        <p> - By email: helpukrainiancanada@gmail.com</p>
